...
def load_fine_tuned_model():
    ...
    model = SentenceTransformer(r"C:\Users\sanke\OneDrive\Pictures\fine-tuning-build-project-main\fine-tuning-build-project-main\streamlit_app\data\fine-tuned-model", device=device)
    return model
